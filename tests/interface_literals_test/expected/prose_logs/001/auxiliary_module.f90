...
IMPLICIT NONE
public get_param_real_wrapper_0004008xxxxxxx_to_00080088000088
INTERFACE get_param_real_wrapper_0004008xxxxxxx_to_00080088000088
MODULE PROCEDURE get_param_real_wrapper_0004008xxxxxxx_to_00080088000088
END INTERFACE 
public get_param
INTERFACE get_param
...
SUBROUTINE get_param_real_wrapper_0004008xxxxxxx_to_00080088000088(cs,modulename,varname,value,desc,units,default)
TYPE ( param_file_type ) , INTENT(IN) :: cs
CHARACTER(len=*), INTENT(IN) :: modulename
CHARACTER(len=*), INTENT(IN) :: varname
REAL(kind=4), INTENT(INOUT) :: value
REAL(kind=8) :: value_temp
CHARACTER(len=*), INTENT(IN) :: desc
CHARACTER(len=*), INTENT(IN) :: units
REAL(kind=8), INTENT(IN), OPTIONAL :: default
value_temp = value
CALL get_param_real(CS=cs,modulename=modulename,varname=varname,value=value_temp,desc=desc,units=units,default=default)
value = value_temp
END SUBROUTINE 
