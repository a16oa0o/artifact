...
USE auxiliary_module, ONLY : right_wrapper_848_to_88g
USE auxiliary_module, ONLY : right_wrapper_44x_to_88g
USE auxiliary_module, ONLY : right_wrapper_448_to_88g
USE auxiliary_module, ONLY : right_wrapper_4xx_to_88g
...
REAL(kind=4) :: result3 = 3.0
REAL(kind=8) :: result4 = 4.0
REAL(kind=8) :: i_in
i_in = 2.0_8
CALL right_wrapper_4xx_to_88g(result1)
CALL right_wrapper_448_to_88g(result2,i_in,result1)
CALL right_wrapper_44x_to_88g(result3,op2_in=result2)
CALL right_wrapper_848_to_88g(result4,op2_in=result3,op1_in=i_in)
