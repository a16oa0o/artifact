...
END INTERFACE 
public right_wrapper_48g_to_88g
INTERFACE right_wrapper_48g_to_88g
MODULE PROCEDURE right_wrapper_48g_to_88g
END INTERFACE 
public foo
INTERFACE foo
...
SUBROUTINE right_wrapper_48g_to_88g(result,op1_in,op2_in)
REAL(kind=4), INTENT(INOUT) :: result
REAL(kind=8) :: result_temp
REAL(kind=8), INTENT(IN), OPTIONAL :: op2_in
REAL(kind=16), INTENT(IN), OPTIONAL :: op1_in
result_temp = result
CALL right(result=result_temp,op1_in=op1_in,op2_in=op2_in)
result = result_temp
END SUBROUTINE 
