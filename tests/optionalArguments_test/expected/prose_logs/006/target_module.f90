...
USE auxiliary_module, ONLY : right_wrapper_44a_to_88g
USE auxiliary_module, ONLY : right_wrapper_48x_to_88g
...
i_in = 2.0_10
CALL foo(result1)
CALL right_wrapper_88a_to_88g(result2,i_in,result1)
CALL right_wrapper_48x_to_88g(result3,op2_in=result2)
CALL right_wrapper_44a_to_88g(result4,op2_in=result3,op1_in=i_in)
