...
IMPLICIT NONE
public target_subroutine_wrapper_gxx_to_a88
INTERFACE target_subroutine_wrapper_gxx_to_a88
MODULE PROCEDURE target_subroutine_wrapper_gxx_to_a88
END INTERFACE 
CONTAINS
...
SUBROUTINE target_subroutine_wrapper_gxx_to_a88(result)
REAL(kind=16) :: result
