...
result = implicit_bar_wrapper_4_to_8(ib) + explicit_bar_wrapper_8_to_4(eb) + external_implicit_foo_real_wrapper_4_to_8(eifr)
...
REAL(kind=4) FUNCTION implicit_bar_wrapper_4_to_8(x) result(returnValue)
REAL(kind=4) :: x
REAL(kind=8) :: x_temp
x_temp = x
