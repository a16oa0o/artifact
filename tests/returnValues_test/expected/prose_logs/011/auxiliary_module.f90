...
IMPLICIT NONE
public external_explicit_bar_real_wrapper_4_to_8
INTERFACE external_explicit_bar_real_wrapper_4_to_8
MODULE PROCEDURE external_explicit_bar_real_wrapper_4_to_8
END INTERFACE 
...
REAL FUNCTION external_explicit_bar_real_wrapper_4_to_8(x) result(returnValue)
REAL(kind=4) :: x
REAL(kind=8) :: x_temp
x_temp = x
returnValue = external_explicit_bar_real(x=x_temp)
x = x_temp
END  FUNCTION 
