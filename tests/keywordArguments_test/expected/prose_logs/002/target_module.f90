...
USE auxiliary_module, ONLY : right_wrapper_48x_to_880
...
CALL right_wrapper_48x_to_880(result3,multiplicand=result2)
CALL right_wrapper_440_to_880(result4,multiplicand=result3,iterations=2)
