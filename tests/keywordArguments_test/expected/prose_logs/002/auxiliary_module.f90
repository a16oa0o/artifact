...
END INTERFACE 
public right_wrapper_48x_to_880
INTERFACE right_wrapper_48x_to_880
MODULE PROCEDURE right_wrapper_48x_to_880
END INTERFACE 
public generic_name
...
SUBROUTINE right_wrapper_48x_to_880(result,multiplicand)
REAL(kind=4) :: result
REAL(kind=8) :: result_temp
REAL(kind=8), OPTIONAL :: multiplicand
result_temp = result
CALL right(result=result_temp,multiplicand=multiplicand)
result = result_temp
END SUBROUTINE 
