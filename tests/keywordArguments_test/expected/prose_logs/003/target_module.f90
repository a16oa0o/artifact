...
USE auxiliary_module, ONLY : right_wrapper_84x_to_880
...
CALL right_wrapper_84x_to_880(result3,multiplicand=result2)
CALL generic_name(result4,multiplicand=result3,iterations=2)
